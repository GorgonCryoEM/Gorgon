...
MODIFICATIONS:
  ...
  -- LAPACK auxiliary routine (version 3.0) --
     ...
     September 30, 1994
*************************************************************************/
inline void generatereflection(ap::real_1d_array& x, int n, double& tau);
...
Output parameters:
  ...
  -- LAPACK auxiliary routine (version 3.0) --
     ...
     September 30, 1994
*************************************************************************/
inline void applyreflectionfromtheleft(ap::real_2d_array& c,
     double tau,
...
Output parameters:
  ...
  -- LAPACK auxiliary routine (version 3.0) --
     ...
     September 30, 1994
*************************************************************************/
inline void applyreflectionfromtheright(ap::real_2d_array& c,
     double tau,
     const ap::real_1d_array& v,
     int m1,
     int m2,
...
inline void generatereflection(ap::real_1d_array& x, int n, double& tau)
{
    ...
    if( mx!=0 )
    {
        if( mx<=ap::minrealnumber/ap::machineepsilon )
        {
            s = ap::minrealnumber/ap::machineepsilon;
            v = 1/s;
            ap::vmul(&x(1), ap::vlen(1,n), v);
            mx = mx*v;
        }
        else
        {
            if( mx>=ap::maxrealnumber*ap::machineepsilon )
            {
