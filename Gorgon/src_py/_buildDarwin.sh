...
cp -v /Users/durmaz/Documents/boost_1_57_0/stage/lib/libboost_python.dylib $fboost 
cp -v /opt/local/lib/libfftw3f.dylib .

rm libpyGORGON.so libpyGORGON.dylib
rm -R dist
rm -R build
...
cp -v ~/Gorgon/lib/libpyGORGON.dylib dist/gorgon.app/Contents/Frameworks
