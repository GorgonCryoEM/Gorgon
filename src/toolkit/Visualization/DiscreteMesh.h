...
namespace Core {
    ...
    class DiscreteMesh : public Volume {
        public:
            ...
            static int getImmersionN6Count           (const Volume & src, Vec3I point);
            static int getImmersionSkeletalValue     (const Volume & src, Vec3I point);
            static bool isImmersionBoundary          (const Volume & src, Vec3I point);
