...
namespace Core {
    ...
    int DiscreteMesh::getN18(vector<Vec3I> & n18,
                             int x, int y, int z)
    {
        n18.resize(18);
        int n18Count = 0;
    ...
    int DiscreteMesh::getN26(vector<Vec3I> & n26,
                             int x, int y, int z)
    {
        int n26Count = 0;
        n26.resize(26);
    ...
    int DiscreteMesh::getImmersionN6Count(Vec3I point) {
    ...
    int DiscreteMesh::getImmersionSkeletalValue(Vec3I point) {
