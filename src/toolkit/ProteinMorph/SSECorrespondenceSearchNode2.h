...
namespace wustl_mm {
	namespace Protein_Morph {
		...
		inline SSECorrespondenceSearchNode2::SSECorrespondenceSearchNode2() {
			cliqueHistory.clear();
		}

		inline SSECorrespondenceSearchNode2::SSECorrespondenceSearchNode2(unsigned int newClique) {
			cliqueHistory.clear();
			cliqueHistory.push_back(newClique);
		}

		inline SSECorrespondenceSearchNode2::SSECorrespondenceSearchNode2(SSECorrespondenceSearchNode2 & oldNode, unsigned int newClique) {
		...
		inline void SSECorrespondenceSearchNode2::AddClique(unsigned int cliqueIndex) {
			cliqueHistory.push_back(cliqueIndex);
		}

		inline vector<SSECorrespondenceSearchNode2 *> SSECorrespondenceSearchNode2::GetChildNodes(vector< set<unsigned long long> > & allCliques, vector< set<unsigned long long> > & cliqueFeaturesP, vector< set<unsigned long long> > & cliqueFeaturesQ, int levelSizeTolerence) {
		...
		inline float SSECorrespondenceSearchNode2::GetCliqueDistances(vector<unsigned long long> & clique1, vector<unsigned long long> & clique2, vector<SSECorrespondenceNode> & allNodes, vector<SSECorrespondenceFeature> & featureList1, vector<SSECorrespondenceFeature> & featureList2) {
		...
		inline float SSECorrespondenceSearchNode2::GetCost(float parentCost, vector< set<unsigned long long> > & allCliques, vector<SSECorrespondenceNode> & allNodes, vector<SSECorrespondenceFeature> & featureList1, vector<SSECorrespondenceFeature> & featureList2) {
			float currCost = 0;
		...
		inline void SSECorrespondenceSearchNode2::PrintSolution(vector< set<unsigned long long> > & allCliques, vector<SSECorrespondenceNode> & allNodes, bool useDirection, bool onlyCorr) {
			printf("corr= {\n");
