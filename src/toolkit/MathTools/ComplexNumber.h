...
namespace wustl_mm {
	namespace MathTools {
		...
		inline ComplexNumber::ComplexNumber(double realComponent, double imaginaryComponent) {
			iValue = imaginaryComponent;
			value = realComponent;
		}


		inline ComplexNumber& ComplexNumber::operator=(const double& d) {
			value = d;
			iValue = 0;
			return *this;
		}
		inline ComplexNumber& ComplexNumber::operator=(const ComplexNumber& d) {
			iValue = d.iValue;
			value = d.value;
			return *this;
		}
		...
		inline ComplexNumber ComplexNumber::operator-() const {
			return ComplexNumber(-value, -iValue);
		}

		inline ComplexNumber ComplexNumber::operator+( const ComplexNumber &d ) const {
			return ComplexNumber(value + d.value, iValue + d.iValue);
		}	  

		inline ComplexNumber ComplexNumber::operator+( const double &d ) const {
		...
		inline void ComplexNumber::SquareRoot() {
		...
		inline void ComplexNumber::CubeRoot(int rootCount) {
		...
		inline ComplexNumber ComplexNumber::Pow(ComplexNumber n, double p, int piTimes) {
		...
		inline bool ComplexNumber::IsZero() {
