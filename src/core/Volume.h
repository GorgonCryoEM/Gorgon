...
namespace Core {
    ...
    class Volume : public VolumeData {
        public:
            ...
            double getMean(); // Returns the mean value of all the voxels
            double getEdgeMean(); // Returns the mean value of all the surface voxels but no interior voxels
            double getStdDev(); // Returns the population standard deviation of the values at all the voxels
