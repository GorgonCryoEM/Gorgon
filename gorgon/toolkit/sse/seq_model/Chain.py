...
class Chain(baseClass):
    ...
    sideChainConnectivity = {
        ...
        'ARG': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'CD'], ['CD', 'NE'],
                ['NE', 'CZ'], ['CZ', 'NH1'], ['CZ', 'NH2']],
        'ASP': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'OD1'], ['CG', 'OD2']],
        'ASN': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'OD1'], ['CG', 'ND2']],
        'CYS': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'SG']],
        'GLY': [['N', 'CA'], ['CA', 'C'], ['C', 'O']],
        'GLN': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'CD'], ['CD', 'NE2'],
                ['CD', 'OE1']],
        'GLU': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'CD'], ['CD', 'OE1'],
                ['CD', 'OE2']],
        'HIS': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'CD2'], ['CD2', 'NE2'],
                ['NE2', 'CE1'], ['CG', 'ND1'], ['ND1', 'CE1']],
        'ILE': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG1'], ['CG1', 'CD1'], ['CB', 'CG2']],
        'LEU': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'CD1'], ['CG', 'CD2']],
        'LYS': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'CD'], ['CD', 'CE'],
                ['CE', 'NZ']],
        ...
        'TRP': [['N', 'CA'], ['CA', 'C'], ['C', 'O'], ['CA', 'CB'], ['CB', 'CG'], ['CG', 'CD1'], ['CG', 'CD2'],
                ['CD1', 'NE1'], ['NE1', 'CE2'], ['CD2', 'CE2'], ['CD2', 'CE3'], ['CE3', 'CZ3'], ['CZ3', 'CH2'],
                ['CH2', 'CZ2'], ['CE2', 'CZ2']],
    ...
    def toPDB(self, backboneOnly=False, CAlphaPlaceholders=True, verbose=True):
        ...
        for index in residueIndices[::13]:
            ...
            for n in range(13):
                try:
                    ...
                    continue
            line = 'SEQRES %s %s %s  %s %s %s %s %s %s %s %s %s %s %s %s %s' % (
            str(i).rjust(3), self.getChainID(), str(len(residueIndices)).rjust(4),
        ...
        for residue_index in self.residueRange():
            ...
            try:
                ...
                if verbose:
                    print "Chain.toPDB() warning:  No atom record for %s in %s%s." % (
                    atom_name, residue_index, residue.symbol3)
