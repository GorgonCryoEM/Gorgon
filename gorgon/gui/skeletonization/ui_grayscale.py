...
class Ui_DialogVolumeGrayscaleSkeletonization(object):
    def setupUi(self, DialogVolumeGrayscaleSkeletonization):
        ...
        self.horizontalSliderIsoLevel = QtGui.QSlider(DialogVolumeGrayscaleSkeletonization)
        ...
        self.labelIsoValueDisplay = QtGui.QLabel(DialogVolumeGrayscaleSkeletonization)

        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum,QtGui.QSizePolicy.Minimum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelIsoValueDisplay.sizePolicy().hasHeightForWidth())
        self.labelIsoValueDisplay.setSizePolicy(sizePolicy)
        self.labelIsoValueDisplay.setMinimumSize(QtCore.QSize(10, 0))
        ...
        DialogVolumeGrayscaleSkeletonization.setTabOrder(self.textCitation, self.horizontalSliderIsoLevel)
        DialogVolumeGrayscaleSkeletonization.setTabOrder(self.horizontalSliderIsoLevel, self.horizontalSliderStepCount)
    ...
    def retranslateUi(self, DialogVolumeGrayscaleSkeletonization):
        ...
        self.horizontalSliderIsoLevel.setWhatsThis(QtGui.QApplication.translate("DialogVolumeGrayscaleSkeletonization", "Picks the density to use when performing skeletonization", None, QtGui.QApplication.UnicodeUTF8))
        self.labelIsoValueDisplay.setText(QtGui.QApplication.translate("DialogVolumeGrayscaleSkeletonization", "128", None, QtGui.QApplication.UnicodeUTF8))
