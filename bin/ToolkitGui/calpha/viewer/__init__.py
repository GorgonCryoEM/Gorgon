...
from ToolkitGui.calpha.choose_chain.to_load_form import CAlphaChooseChainToLoadForm
...
class CAlphaViewer(BaseViewer):
    ...
    # from .gui import setDisplayStyle
    # from .gui import getDrawColors
    # from .gui import getDrawVisibility
    # from .gui import emitElementClicked
    # from .gui import emitElementSelected
    # from .gui import emitElementMouseOver
